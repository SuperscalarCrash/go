...
func ParseFlags() {
	...
	*Flag.DwarfLocationLists = true
	...
	loong32rShared := Ctxt.Arch.Family == sys.Loong32r
	if (*Flag.Shared || *Flag.Dynlink || *Flag.LinkShared) && !loong32rShared && !Ctxt.Arch.InFamily(sys.AMD64, sys.ARM, sys.ARM64, sys.I386, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X) {
