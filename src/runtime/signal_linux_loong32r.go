...
func (c *sigctxt) sp() uint32  { return uint32(c.regs().sc_regs[3]) }

//go:nosplit
//go:nowritebarrierrec
func (c *sigctxt) pc() uint32 { return uint32(c.regs().sc_pc) }

func (c *sigctxt) link() uint32    { return uint32(c.regs().sc_regs[1]) }
func (c *sigctxt) sigcode() uint32 { return uint32(c.info.si_code) }
func (c *sigctxt) sigaddr() uint32 { return c.info.si_addr }

func (c *sigctxt) set_r22(x uint32)  { c.regs().sc_regs[22] = uint64(x) }
func (c *sigctxt) set_pc(x uint32)   { c.regs().sc_pc = uint64(x) }
func (c *sigctxt) set_sp(x uint32)   { c.regs().sc_regs[3] = uint64(x) }
func (c *sigctxt) set_link(x uint32) { c.regs().sc_regs[1] = uint64(x) }
